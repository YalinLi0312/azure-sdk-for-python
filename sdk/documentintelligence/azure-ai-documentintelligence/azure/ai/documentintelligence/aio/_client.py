...
from ._configuration import DocumentIntelligenceClientConfiguration
from .operations import DocumentClassifiersOperations, DocumentModelsOperations, MiscellaneousOperationsOperations
...
class DocumentIntelligenceClient:  # pylint: disable=client-accepts-api-version-keyword
    """Extracts content, layout, and structured data from documents.

    :ivar miscellaneous_operations: MiscellaneousOperationsOperations operations
    :vartype miscellaneous_operations:
     azure.ai.documentintelligence.aio.operations.MiscellaneousOperationsOperations
    :ivar document_models: DocumentModelsOperations operations
    :vartype document_models: azure.ai.documentintelligence.aio.operations.DocumentModelsOperations
    :ivar document_classifiers: DocumentClassifiersOperations operations
    :vartype document_classifiers:
     azure.ai.documentintelligence.aio.operations.DocumentClassifiersOperations
    ...
    def __init__(
        ...
        self.miscellaneous_operations = MiscellaneousOperationsOperations(
