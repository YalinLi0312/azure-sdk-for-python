...
"""
FILE: sample_get_batch_analyze_result.py

DESCRIPTION:
    This sample demonstrates how to get batch documents analyzed result.
...
USAGE:
    python sample_get_batch_analyze_result.py
...
def analyze_result_figures():
    ...
    # [START get_batch_analyze_result]
    from azure.core.credentials import AzureKeyCredential
    from azure.ai.documentintelligence import DocumentIntelligenceClient
    from azure.ai.documentintelligence.models import AnalyzeOutputOption, AnalyzeBatchResult
